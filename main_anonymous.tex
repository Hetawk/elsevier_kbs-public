...
%% Use the options 1p,twocolumn; 3p; 3p,twocolumn; 5p; oThis study utilized two publicly available datasets for medical image classification tasks:
\begin{enumerate}
...
%% Navigation and bookmark packages for anonymous version
\usepackage[bookmarks=true,bookmarksnumbered=true,bookmarksopen=true,
           ...
           pdftitle={MedDef: An Efficient Self-Attention Model for Adversarial Resilience in Medical Imaging with Unstructured Pruning (Anonymous Version)},
           pdfauthor={Anonymous},
